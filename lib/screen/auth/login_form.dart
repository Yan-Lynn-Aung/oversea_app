...
class LoginForm extends StatefulWidget {
  ...
  LoginForm({Key key, @required this.authapiRepository})
      : assert(authapiRepository != null),
        super(key: key);

  @override
  State<LoginForm> createState() => _LoginFormState(authapiRepository);
}

class _LoginFormState extends State<LoginForm> {
  final AuthapiRepository authapiRepository;
  _LoginFormState(this.authapiRepository);
